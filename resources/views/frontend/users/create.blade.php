                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="full_address" id="full_address" value="{{ old('full_address', '') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="postal_address" id="postal_address" value="{{ old('postal_address', '') }}">
