    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.uploads.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="name_id">{{ trans('cruds.upload.fields.name') }}</label>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" name="upload_name" id="upload_name" required>{{ old('upload_name', '') }}</textarea>
                <!--<input class="form-control {{ $errors->has('upload_name') ? 'is-invalid' : '' }}" type="text" name="upload_name" id="upload_name" value="{{ old('upload_name', '') }}" required>-->
            ...
            <div class="form-group">
                <label class="required"  for="upload">{{ trans('cruds.upload.fields.upload') }}</label>
