    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.uploads.update", [$upload->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('upload_name') ? 'is-invalid' : '' }}" type="text" name="upload_name" id="upload_name" value="{{ old('upload_name', $upload->upload_name) }}" required>
