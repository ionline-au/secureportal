                    ...
                    @foreach($users as $key => $user)
                        <tr data-entry-id="{{ $user->id }}">
                            ...
                            <td>
                                ...
                                <div style="clear: both;">
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.uploads.index', ['user_id' => $user->id]) }}">
                                        Review Uploads
                                    </a>
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.users.history', ['user_id' => $user->id]) }}">
                                        Review History
                                    </a>
                                </div>
                                <div style="clear: both;">
